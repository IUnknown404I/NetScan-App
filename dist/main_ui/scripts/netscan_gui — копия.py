...
def run_nmap_scan_list(ip_address):
    ...
    print('\n[*] Process for {ip_address} done! Elapsed time: {elapsed_time}'.format(ip_address=ip_address, elapsed_time=stop_time))
    nettemp.write('\n[*] Process for {ip_address} done! Elapsed time: {elapsed_time}\n\n'.format(ip_address=ip_address, elapsed_time=stop_time))
    nettemp.close()
